...
public class DatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    public static final String DATABASE_NAME = "items_fire.db";
    public static final String TABLE_ITEMS = "items_firebasetable";
    ...
    public void clearDatabase(String TABLE_ITEM) {
        SQLiteDatabase db = this.getWritableDatabase();
        String clearDBQuery = "DELETE FROM " + "items_firebasetable";
