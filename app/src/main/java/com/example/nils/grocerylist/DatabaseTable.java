...
//                    + KEY_NAME + " TEXT, " + KEY_PRICE + " TEXT," + KEY_PPU + " TEXT, " + KEY_CALORIES + " TEXT, "
//            + KEY_FATCALORIES + " TEXT, " + KEY_SODIUM + " TEXT, " + KEY_CARBS + " TEXT, " + KEY_FIBER + " TEXT, " +
//                KEY_SUGAR + " TEXT, " + KEY_PROTEIN + " TEXT, " + KEY_INGREDIENTS + " TEXT" + ")";
